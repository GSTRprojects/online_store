<div id="product">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div id="gallery">
                    <div id="gallery-big" class="mb20">
                        <div class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></div>
                        <div class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></div>
                        <div class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></div>
                        <div class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></div>
                        <div class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></div>
                    ...
                    <div id="gallery-mini">
                        <a href="#" class="item active"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></a>
                        <a href="#" class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></a>
                        <a href="#" class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></a>
                        <a href="#" class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></a>
                        <a href="#" class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></a>
                        <a href="#" class="item"><img class="lazyOwl img-responsive" data-src="img/products/featured.jpg" alt="Lazy Owl Image"></a>
                    ...
                    <script type="text/javascript">
                        ...
                        $("#gallery-mini a").click(function () {
                            ...
                            // pobiera index aktualne klikniętego elementu
            ...
            <div class="col-md-8">
                <h1 class="font-open-sans font-weight-400">Telefon</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="product-price text-center">
                                <span class="price font-size-bigger">449,00 zł</span>
                            </div>
